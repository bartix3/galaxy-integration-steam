...
class ApplicationError(JsonRpcError):
    def __init__(self, code: int, message: str, data: Optional[Mapping]) -> None: ...
...
def anonymise_sensitive_params(params: Dict[str, Any], sensitive_params: Union[bool, Iterable[str]]): ...

class Connection:
    def __init__(self, reader: StreamReader, writer: StreamWriter, encoder: JSONEncoder = ...) -> None: ...
    def register_method(self, name: str, callback: Callable, immediate: bool, sensitive_params: Union[bool, Iterable[str]] = ...) -> None: ...
    def register_notification(self, name: str, callback: Callable, immediate: bool, sensitive_params: Union[bool, Iterable[str]] = ...) -> None: ...
